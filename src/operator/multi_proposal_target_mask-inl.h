...
#ifndef MXNET_OPERATOR_MULTI_PROPOSAL_TARGET_MASK_INL_H_
#define MXNET_OPERATOR_MULTI_PROPOSAL_TARGET_MASK_INL_H_
...
struct MultiProposalTargetMaskParam : public dmlc::Parameter<MultiProposalTargetMaskParam> {
  ...
  DMLC_DECLARE_PARAMETER(MultiProposalTargetMaskParam) {
    ...
    DMLC_DECLARE_FIELD(max_gts).set_default(100)
...
Operator *CreateOp(MultiProposalTargetMaskParam param);

#if DMLC_USE_CXX11
class MultiProposalTargetMaskProp : public OperatorProperty {
 public:
  ...
  OperatorProperty* Copy() const override {
    auto ptr = new MultiProposalTargetMaskProp();
    ptr->param_ = param_;
    return ptr;
  }
